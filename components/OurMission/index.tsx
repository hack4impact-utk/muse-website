  ...
  return (
    <div className={styles.wrapper}>
      ...
      <div className={styles.missionText}>
        ...
        justo, rutrum in odio a, convallis pharetra lacus. Aenean accumsan risus
        mauris, quis pharetra ipsum rhoncus id. Nam gravida orci in libero
        dictum fringilla. Vestibulum ante ipsum primis in faucibus orci luctus
        et ultrices posuere cubilia curae; Phasellus semper accumsan iaculis.
        Donec sit amet porttitor sem, at vulputate lacus. Mauris varius tortor
        at mollis placerat. Vivamus ut lectus eu dui rutrum malesuada nec in
        odio.
      </div>
